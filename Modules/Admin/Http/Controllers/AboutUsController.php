...
use Modules\Admin\Entities\About_Us;
...
class AboutUsController extends Controller
{
   ...
   public function index(Request $request)
    ...
    public function update(Request $request, $id)
    {
        ...
        unset($input['_token']);
        unset($input['_method']);
        About_Us::whereId($id)->update($input);   
        return back()->with('success','about us has been updated successfully.');
    }
