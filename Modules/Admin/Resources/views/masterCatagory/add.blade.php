			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="card card-primary">
						...
						<form action="{{ route('master-categories.store') }}" method="POST" enctype="multipart/form-data">
							@csrf
							<div class="card-body">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="master_category_name" name="master_category_name" placeholder="Enter Master Category Name">
											@error('name')
