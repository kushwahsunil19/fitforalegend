							...
							<div class="col-12">
								...
								<div class="card">
									<div class="card-header">
										...
										<a href="{{route('master-categories.create')}}" class="btn btn-success float-right">Create new Master Category</a>
									</div>
  ...
  $(function () {
   ...
   function deleted(e) {
    ...
    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
     ...
     if (confirm("Are You sure want to delete this master category!") == true) {
              $.ajax({
                  url    : url,
                  type   : "delete",
