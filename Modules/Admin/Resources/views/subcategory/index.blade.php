							...
							<div class="col-12">
								...
								<div class="card">
									<div class="card-header">
										...
										<a href="{{route('sub-categories.create')}}" class="btn btn-success float-right">Create new Sub Category</a>
									</div>
  ...
  $(function () {
   ...
   function deleted(e) {
    ...
    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
     ...
     if (confirm("Are You sure want to delete this sub category!") == true) {
              $.ajax({
                  url    : url,
                  type   : "delete",
